...
public class PongEnvironment
{
	...
	private byte leftScore = 0, rightScore = 0;
	...
	public void setComputer(boolean a, boolean b)
	{
		rightComputer = a;
		leftComputer = b;
	}
	...
	{
		ball.move();
		if(ball.getLocation().getY() - Ball.TIME <= 0)
			ball.bounceTop();
		else if(ball.getLocation().getY() + Ball.TIME >= HEIGHT)
			ball.bounceTop();
